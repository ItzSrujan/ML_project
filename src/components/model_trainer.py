...
class ModelTrainerConfig:
    trained_model_file_path = os.path.join(os.getcwd(),"pickle_artifacts","model.pkl")
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_arr, test_arr):
        try:
            ...
            ## To get best model score and model name
            ...
            logging.info(f"Score of the Best model : {best_model_name} is {score}")
